      ...
      <main>
        <section className="struka-hero">
          <div className="container struka-header">
            <div className="struka-icon"><i className="fas fa-user-tie"></i></div>
            <h1>{t("direktor.title")}</h1>
            <p>{t("direktor.subtitle")}</p>
          </div>
        </section>
        ...
        <section style={{ padding: "50px 0" }}>
          <div className="container" style={{ maxWidth: "900px" }}>
            <div style={{ textAlign: "center", marginBottom: "40px" }}>
              <ImageModal src={rakovodstvo7} alt={t("direktor.name")} style={{ width: "200px", borderRadius: "50%", boxShadow: "0 8px 30px rgba(0,0,0,0.15)" }} />
            ...
            <div style={{ lineHeight: 1.8, color: "#2E6899", background: "white", padding: "30px", borderRadius: "20px", boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
              <p>{t("direktor.bio1")}</p>
              <p style={{ marginTop: "15px" }}>{t("direktor.bio2")}</p>
            </div>

            <h3 style={{ textAlign: "center", marginTop: "40px", marginBottom: "20px", color: "#4B8BBE", fontSize: "1.4rem" }}>
              <i className="fas fa-images"></i> {t("direktor.gallery")}
            </h3>
            <div className="leadership-gallery">
              <ImageModal src={rakovodstvo1} alt="Gallery 1" />
              <ImageModal src={rakovodstvo2} alt="Gallery 2" />
              <ImageModal src={rakovodstvo3} alt="Gallery 3" />
            </div>
          </div>
        </section>
        ...
        <section className="back-section">
          <div className="container">
            <Link to="/za-nas" className="back-button">
              <i className="fas fa-arrow-left"></i> {t("direktor.back")}
            </Link>
          </div>
        </section>
      </main>
